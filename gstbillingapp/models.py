...
class UserProfile(models.Model):
    ...
    business_pan = models.CharField(max_length=20, blank=True, null=True)
    business_bank_details = models.TextField(max_length=500, blank=True, null=True)
...
class Invoice(models.Model):
    ...
    invoice_payment_type = models.CharField(max_length=255, blank=True, null=True)
...
class Product(models.Model):
    ...
    product_rate_without_gst = models.FloatField()
    def __str__(self):
